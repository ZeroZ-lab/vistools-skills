...
allowed-tools: Bash(vistools *) Bash(jq *) Bash(sips *) Bash(which *) Read
---
...
**Prerequisite**: `vistools` must be in PATH. If not found, tell the user to install it (see "Setup" at the end).
